...
class MainWindow(QMainWindow):
    ...
    def getDesPoint(self,image,start_point,dest_point):
        ...
        endpt_x = int(start_point[0] - 5000*np.cos(theta))
        endpt_y = int(start_point[1] - 5000*np.sin(theta))
    ...
    def processImage(self):
        if self.flag:
            ...
            if dataResult is not None:
                    ...
                    ret,thresh_tem = cv2.threshold(gray.copy(),190,255,cv2.THRESH_BINARY)
                    ...
                    blur_img = cv2.medianBlur(gray,121)
                    ...
                    detected_circles = cv2.HoughCircles(dilation, method=cv2.HOUGH_GRADIENT, dp=1, minDist=50, param1=50, param2=15,
